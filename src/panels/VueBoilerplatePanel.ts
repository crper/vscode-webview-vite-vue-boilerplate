 ...
 */
export class VueBoilerplatePanel {
  public static currentPanel: VueBoilerplatePanel | undefined;
  ...
  public static render(extensionUri: Uri) {
    if (VueBoilerplatePanel.currentPanel) {
      ...
      VueBoilerplatePanel.currentPanel._panel.reveal(ViewColumn.One);
    } else {
      ...
      VueBoilerplatePanel.currentPanel = new VueBoilerplatePanel(panel, extensionUri);
    }
  }
   ...
   */
  public dispose() {
    VueBoilerplatePanel.currentPanel = undefined;
